        ...
        <div class="row mb">
          ...
          <div class="content-panel">
            <div class="adv-table">
              ...
              <h4><i class="fa fa-angle-right"></i><?php echo anchor('ward/add_ward/',"<button>Add staff</button>");?></h4>
            <hr>
            <thead>
              <tr>
              ...
              <th><h4> <i></i>   Id</h4></th>
                <th><h4><i></i> ward Name   </h4></th>
                <th><h4><i></i> number of bed<h4></th>
                <th><h4><i></i>  number of staff  <h4></th>
                <th><h4><i></i>  number of patients  <h4></th>
...
<!--main content end-->
          <?php
                foreach ($wards as $raw){ ?>
                    <tr>
        <td><?php echo "<h4>".$raw->id."</h4>"?></td>
        <td><?php echo "<h4>".$raw->wardName."</h4>"?></td>
        <td><?php echo "<h4>".$raw->numberOfBed."</h4>"?></td>
        <td><?php echo "<h4>".$raw->numberOfStaff."</h4>"?></td>
        <td><?php echo "<h4>".$raw->numberOfPatient."</h4>"?></td>
