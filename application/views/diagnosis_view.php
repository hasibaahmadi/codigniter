        ...
        <div class="row mb">
          ...
          <div class="content-panel">
            <div class="adv-table">
              ...
              <h4><i class="fa fa-angle-right"></i><?php echo anchor('diagnosis/add_diagnosis/',"<button>Add diagnosis</button>");?></h4>
            <hr>
            <thead>
              <tr>
              ...
              <th><h4> <i></i>   Id</h4></th>
                <th><h4><i></i> patient Id  </h4></th>
                <th><h4><i></i> Date<h4></th>
                <th><h4><i></i> Upload By  <h4></th>
                <th><h4><i></i> Diagnosed By  <h4></th>
                <th><h4><i></i> Diagnosed Summary   <h4></th>
...
<!--main content end-->
          <?php
                foreach ($diagnosis as $raw){ ?>
                    <tr>
        <td><?php echo "<h4>".$raw->id."</h4>"?></td>
        <td><?php echo "<h4>".$raw->patientId."</h4>"?></td>
        <td><?php echo "<h4>".$raw->date."</h4>"?></td>
        <td><?php echo "<h4>".$raw->uploadBy."</h4>"?></td>
        <td><?php echo "<h4>".$raw->diagnosedby."</h4>"?></td>
        <td><?php echo "<h4>".$raw->diagnosesSummary."</h4>"?></td>
