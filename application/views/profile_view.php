            ...
            <div class="row content-panel">
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p><img src="<?= base_url()?>file/img/service.png" class="img-circle"></p>
                  <p>
            ...
            <div class="row content-panel">
              <div class="panel-heading">
                <ul class="nav nav-tabs nav-justified">
                  ...
                  <li>
                    <a data-toggle="tab" href="<?= base_url()?>/index.php/profile/edit">Edit Profile</a>
                  </li>
                </ul>
              </div>
              <!-- /panel-heading -->
              <div class="panel-body">
                <div class="tab-content">
                  ...
                  <!-- /tab-pane -->
                  <div id="<?= base_url()?>/edit" class="tab-pane">
                    <div class="row">
